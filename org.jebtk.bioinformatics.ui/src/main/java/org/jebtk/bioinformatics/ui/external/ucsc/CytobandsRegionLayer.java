...
public class CytobandsRegionLayer extends CytobandsLayer {
	...
	private static final GenomicRegion DEFAULT_REGION = 
			new GenomicRegion(ChromosomeService.getInstance().human("chr1"), 1, 1000);

	/** The Constant REGION_COLOR. */
	private static final Color REGION_COLOR = Color.RED;

	/** The Constant REGION_FILL_COLOR. */
	private static final Color REGION_FILL_COLOR = 
			ColorUtils.getTransparentColor75(REGION_COLOR);
	...
	public void plotLayer(Graphics2D g2,
		...
		drawTriangle(g2, x1, y);
		drawTriangle(g2, Math.max(x1 + w, x2), y);
		*/
	}
